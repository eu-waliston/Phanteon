...
router.patch('/:id/toggle-active', auth, isAdmin, championController.toggleActive);
router.patch('/:id/toggle-featured', auth, isAdmin, championController.toggleFeatured);
